...
/----------------------------------------------------------------------------*/
#ifndef LOVYANHAL_PLATFORMS_HOST_LOVYANHAL_PC_HPP_
#define LOVYANHAL_PLATFORMS_HOST_LOVYANHAL_PC_HPP_
...
namespace lhal
{
 namespace v0
 {
  ...
  public:
    ...
    error_t getLastError(void) override;
...
//*/
  ...
  public:
    ...
    TransactionSPI createTransaction(void) { return TransactionSPI(this); }
...
/*
    error_t beginTransaction(bool read = false, int dummy_clock_bits = 0) override;
...
//*/
  ...
  public:
    ...
    TransactionI2C createTransaction(void) { return TransactionI2C(this); }
